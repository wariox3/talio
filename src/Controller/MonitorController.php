...
class MonitorController extends AbstractController
{
    ...
    public function monitor(Request $request, Wolframio $wolframio, Niquel $niquel, Tantalo $tantalo, Carbono $carbono): Response
    {
        ...
        return $this->render('monitor.html.twig', [
